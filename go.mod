module github.com/jakebailey/ua
...
require (
	...
	github.com/docker/docker v0.7.3-0.20190223142059-dd945557876b
...
replace github.com/satori/go.uuid => github.com/gofrs/uuid v2.1.0+incompatible
